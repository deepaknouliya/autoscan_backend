...
router.post("/create-varient",fileUpload.any(), varientController.createVarient);
router.delete("/delete-varient/:id", varientController.deleteVarientById);
router.patch("/update-varient/:id",fileUpload.any(),varientController.updateVarient);
